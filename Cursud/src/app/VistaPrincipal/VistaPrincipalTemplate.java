...
public class VistaPrincipalTemplate extends JFrame{
    ...
    private ImageIcon iJeisson, iUd, iCurso,iSantiago;
    ...
    public void crearDecoracion(){
        ...
        iSantiago = new ImageIcon("recursos/QuienesSomos/santiago.jpeg");
    ...
    public void crearPaneles(){
        ...
        jTarjeta2=sObjetosGraficos.construirJPanel(120, 0, 120, 120, null, sRecursos.getBorderInferiorGris());
        pInfo.add(jTarjeta2);
    ...
    public void crearContenidoTarjeta2(){
        
        this.jTarjeta2.add(new TarjetaComponent(iSantiago).getTarjetaTemplate());
